let mobMenu,subMobMenuBtn, descMenu,subMenu, lines, subMenuId ;
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    (async function getHeader(){
        ...
        try {
            let request = await fetch('components/Headыer/header.html', {method: 'GET'});
            ...
            console.log('Не получилось скачать файл');
        }
    })()    
})
