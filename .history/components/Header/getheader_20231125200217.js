let mobMenu,subMobMenuBtn, descMenu,subMenu, lines, subMenuId,allDistrictSubmenu, allPressCentreSubmenu;
let menuDistrict = {
...
document.addEventListener('DOMContentLoaded', ()=>{
    (async function getHeader(){
        ...
        try {
            ...
            let pressCentreLocation = Object.keys(menuPressCentre).find(key => key == window.location.search.slice(1))
            ...
            }else if(pressCentreLocation){
                import("./../../scripts/pressCentre.js").then(res => {
                    let showNewsItems = res.default;
                    showNewsItems(pressCentreLocation);
                })
            }
