...
let activityArray = [
    {
        bakcground: 'img/activityImg/bg1.png',
        newsSource: 'Раздел1',
        title: 'Длинный заголовок в несколько строк',
    ...
    {
        bakcground: 'img/activityImg/bg2.png',
        newsSource: 'Раздел2',
        title: 'Длинный заголовок в несколько строк',
    ...
    {
        bakcground: 'img/activityImg/bg3.png',
        newsSource: 'Раздел3',
        title: 'Длинный заголовок в несколько строк',
    ...
    {
        bakcground: 'img/activityImg/bg4.png',
        newsSource: 'Раздел4',
        title: 'Длинный заголовок в несколько строк',
        text: 'Текст — зафиксированная на каком-либо материальном носителе человеческая мысль',
        data: '14 февраля 2023',
    ...
    if(index <= arr.length){
        arr.slice(index, index + 3).forEach(item =>{
            ...
            if(img){
                ...
                clonePattern.style.backgroundImg = item.bakcground;
                console.log(item.bakcground);
            }
