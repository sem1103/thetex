...
let videoArray = [
    {
        ...
        title: 'Длинный заголовок в несколько строк',
        data: '14 февраля 2023',
        iframe: '<iframe width="100%"  src="https://www.youtube.com/embed/4xDzrJKXOOY" title="synthwave radio 🌌 - beats to chill/game to" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
    },
    {
...
videoDisplay.append(...videoArray[0].iframe)
let index = 0;
