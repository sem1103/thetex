...
function descBurgerHundler() {
    ...
    let descMenu = Array.from(document.querySelectorAll('.desc__menu > nav > ul > li a'));
    console.log(descMenu);

    for(let i = 0; i < descMenu.length; i++){
        console.log(descMenu[i]);
        descMenu[i].addEventListener('mouseenter', ()=>{
