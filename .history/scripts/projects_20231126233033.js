...
async function getPattern(){
    try {
        ...
        let res = await fetch('components/ProjectPattersn/project.html', {method: 'GET'});
...
async function showProjects(){
    ...
    let btn = document.querySelector('.show__more')
    ...
    btn.style.display = index >= projects.length ? 'none' : 'table'
}
